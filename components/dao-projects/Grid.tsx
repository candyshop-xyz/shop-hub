...
import daoprojects from "../../api/daoprojects.json";
    ...
    <div className="rounded-lg">
      <div className="mx-auto ">
        <div className="devGrid">
          ...
          >
            {daoprojects.map((resource: ResourceProps) => (
              <li key={resource.name} className="sm:py-8">
                ...
                <div className="w-full flex gap-6 xs:flex-col sm:flex-row">
                  <img
                    ...
                    src={`/dao-projects/${resource.imageUrl}`}
                    alt=""
                  />
                </div>
                ...
                <div className="mt-4">
                  ...
                  <a
                    ...
                    rel="noreferrer"
                    key={resource.name}
                    className="inline-flex items-center justify-center rounded-md border border-transparent  px-4 py-2  mt-2 text-sm font-medium shadow-sm  transition duration-100 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:w-auto  bg-blue-base text-white focus:ring-gray-200 hover:bg-opacity-80"
                  >
                    {resource.btnText}
                  </a>
                </div>
