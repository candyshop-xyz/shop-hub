...
const funding = [
  {
    ...
    tagline:
      "small grants provides seed funding to proliferate the mfers meme and build infrastructure for cereal box dao",
  ...
  },
  {
    ...
    tagline:
      "submit proposals to prop.house. cereal box dao maintains and regularly holds prop house funding rounds",
  ...
  },
  {
    ...
    linkText: "learn more",
    tagline:
      "resources allocated for the long-term growth of cereal box dao, proposed and voted on by cereal box dao members",
...
const Funding = ({ grantsData }) => {
  ...
  return (
    <>
      <PageHeader>
        <Header title="funding | mfers hub" />
        <Title title="funding" />

        <Subheader body="cereal box dao funds projects that proliferate the mfers meme and provides value to cereal box dao members. we are currently looking to fund the following projects -- reach out if you would like to work with us." />
      </PageHeader>
